...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-zinc-900 dark:bg-zinc-900 border-r border-zinc-800 flex-col justify-between p-12">
        ...
        <div>
          <blockquote className="text-2xl font-medium text-white leading-snug">
            "Know the moment anything changes — before anyone else does."
          </blockquote>
          <p className="mt-4 text-zinc-500 text-sm">
            AI-powered monitoring for the URLs that matter most.
          </p>
        </div>
        ...
        <div className="flex gap-4 text-xs text-zinc-600">
          ...
          <span>&middot;</span>
          <span>AI significance scoring</span>
          <span>&middot;</span>
          <span>Full snapshot history</span>
        </div>
      </div>
          ...
          <div className="w-full max-w-sm">
            <div className="mb-8">
              ...
              <p className="mt-1.5 text-sm text-zinc-500 dark:text-zinc-400">
                Sign in to your KeepShot account
              </p>
            </div>
